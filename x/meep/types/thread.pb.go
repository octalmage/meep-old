...
func (*Thread) Descriptor() ([]byte, []int) {
	return fileDescriptor_c26fa501fdc9a29b, []int{0}
}
...
func (m *Thread) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func (m *Thread) GetCreatedAt() int64 {
	if m != nil {
		return m.CreatedAt
	}
	return 0
...
func init() {
	proto.RegisterType((*Thread)(nil), "octalmage.meep.meep.Thread")
}

func init() { proto.RegisterFile("meep/thread.proto", fileDescriptor_c26fa501fdc9a29b) }

var fileDescriptor_c26fa501fdc9a29b = []byte{
	// 192 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0xcc, 0x4d, 0x4d, 0x2d,
	0xd0, 0x2f, 0xc9, 0x28, 0x4a, 0x4d, 0x4c, 0xd1, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0xce,
	0x4f, 0x2e, 0x49, 0xcc, 0xc9, 0x4d, 0x4c, 0x4f, 0xd5, 0x03, 0x49, 0x82, 0x09, 0x29, 0x91, 0xf4,
	0xfc, 0xf4, 0x7c, 0xb0, 0xbc, 0x3e, 0x88, 0x05, 0x51, 0xaa, 0x14, 0xc0, 0xc5, 0x16, 0x02, 0xd6,
	...
	0x04, 0x31, 0x65, 0xa6, 0x08, 0xc9, 0x70, 0x71, 0x82, 0xa5, 0x52, 0x53, 0x1c, 0x4b, 0x24, 0x98,
	0x15, 0x18, 0x35, 0x98, 0x83, 0x10, 0x02, 0x4e, 0x0e, 0x27, 0x1e, 0xc9, 0x31, 0x5e, 0x78, 0x24,
	0xc7, 0xf8, 0xe0, 0x91, 0x1c, 0xe3, 0x84, 0xc7, 0x72, 0x0c, 0x17, 0x1e, 0xcb, 0x31, 0xdc, 0x78,
	0x2c, 0xc7, 0x10, 0xa5, 0x96, 0x9e, 0x59, 0x92, 0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0x0f,
	0x77, 0xa1, 0x3e, 0xd8, 0xf9, 0x15, 0x10, 0xaa, 0xa4, 0xb2, 0x20, 0xb5, 0x38, 0x89, 0x0d, 0xec,
	0x34, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x3d, 0x31, 0x6a, 0x89, 0xda, 0x00, 0x00, 0x00,
}
...
func (m *Thread) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.CreatedAt != 0 {
		i = encodeVarintThread(dAtA, i, uint64(m.CreatedAt))
		i--
		dAtA[i] = 0x18
	}
	if m.Id != 0 {
	...
	if len(m.Creator) > 0 {
		...
		i = encodeVarintThread(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Thread) Size() (n int) {
	...
	if m.CreatedAt != 0 {
		n += 1 + sovThread(uint64(m.CreatedAt))
	}
	return n
}
