...
import (
	...
	appparams "github.com/octalmage/meep/app/params"
	"github.com/octalmage/meep/x/meep"
	meepkeeper "github.com/octalmage/meep/x/meep/keeper"
	meeptypes "github.com/octalmage/meep/x/meep/types"
...
func New(
	...
	app.meepKeeper = *meepkeeper.NewKeeper(
		appCodec, keys[meeptypes.StoreKey], keys[meeptypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		meep.NewAppModule(appCodec, app.meepKeeper),
...
func (app *App) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	...
	if len(threads) > 0 {
		for _, s := range threads {
			...
			// TODO: Currently set to 10 minutes.
			if timeToDelete.Unix()+(60*9) < time.Now().Unix() {
